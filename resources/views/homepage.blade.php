    ...
    <div class="container py-md-5">
      <div class="row align-items-center">
        <div class="col-lg-7 py-3 py-md-5">
          ...
          <p class="lead text-muted">Our users have <strong style="color:#f44336">authored {{$postCount}} posts</strong>. <br>Are you sick of short tweets and impersonal &ldquo;shared&rdquo; posts that are reminiscent of the late 90&rsquo;s email forwards? We believe getting back to actually writing is the key to enjoying the internet again. </p>
        </div>
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
              ...
              @error('username')
                <p class="m-90 small alert alert-danger shadow-sm">{{ $message }}</p>
              @enderror
            </div>
