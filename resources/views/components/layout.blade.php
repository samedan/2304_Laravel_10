...
<html lang="en">
  ...
  <body>
          ...
          <!-- LOGGED In USER-->
            ...
            <div class="flex-row my-3 my-md-0">
              ...
              <span class="text-white mr-2 header-chat-icon" title="Chat" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-comment"></i></span>
                ...
                <button class="btn btn-sm" style="background-color:blueviolet;">
         ...
         <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
          ...
          <div class="row align-items-center">
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
              ...
              @error('loginusername')
              <p class="m-90 small alert alert-danger shadow-sm">Username is required</p>
            @enderror
            </div>
            ...
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
              ...
              @error('loginpassword')
              <p class=" m-90 small alert alert-danger shadow-sm">Password is required</p>
              @enderror
            </div>
    ...
    <!-- header ends here -->
        ...
        <!-- SUCCESS login/Logout Message -->
        @if(session()->has('success')) <!-- 'success' comes from UserController -->
        ...
        @endif
        <!-- ERROR login Message -->
        @if(session()->has('failure')) <!-- 'failure' comes from UserController -->
          <div class="container container--narrow">
 ...
 @auth
  <div data-username="{{auth()->user()->username}}" 
    ...
    id="chat-wrapper" class="chat-wrapper shadow border-top border-left border-right">
